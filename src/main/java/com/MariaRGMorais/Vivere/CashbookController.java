...
public class CashbookController {
    ...
    public List < Cashbook > getAllCashbook() {
        return this.cashbookRepository.findAll();
    }
    ...
    public Cashbook updateCashbook(@RequestBody Cashbook cashbook, @PathVariable("id") int cashbookId) {
    	Cashbook existingCashbook = this.cashbookRepository.findById(cashbookId).orElseThrow(() -> new ResourceNotFoundException("Cashbook not found with id :" + cashbookId));
        existingCashbook.setFirstName(cashbook.getFirstName());
